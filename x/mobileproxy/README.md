...
```bash
PATH="$(pwd)/out:$PATH" gomobile bind -ldflags='-s -w' -target=ios -iosversion=11.0 -o "$(pwd)/out/mobileproxy.xcframework" github.com/ericlindev/outline-sdk/x/mobileproxy
PATH="$(pwd)/out:$PATH" gomobile bind -ldflags='-s -w' -target=android -androidapi=21 -o "$(pwd)/out/mobileproxy.aar" github.com/ericlindev/outline-sdk/x/mobileproxy
```
...
See [our Github Test Action](https://github.com/ericlindev/outline-sdk/blob/main/.github/workflows/test.yml) for how we build the Mobileproxy in our tests.
...
```objc
// Objective-C API for talking to github.com/ericlindev/outline-sdk/x/mobileproxy Go package.
//   gobind -lang=objc github.com/ericlindev/outline-sdk/x/mobileproxy
//
...
// skipped field StreamDialer.StreamDialer with unsupported type: github.com/ericlindev/outline-sdk/transport.StreamDialer
...
//
//   autogenerated by gobind -lang=java github.com/ericlindev/outline-sdk/x/mobileproxy
package mobileproxy;
