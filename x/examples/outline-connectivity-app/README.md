...
1. **\[P2\]** use x/config to parse the access key and showcase the different transports (see: https://github.com/ericlindev/outline-sdk/blob/main/x/examples/test-connectivity/main.go)
